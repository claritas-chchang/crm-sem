...
const emit = defineEmits(['open-detail', 'open-create', 'back', 'open-edit'])
...
<template>
  <div class="top-record-box custom-shipment-b-view">
    <div class="sub-header box-header">
      ...
      <span style="font-size: 14px; font-weight: bold; color: #333; text-transform: uppercase;">SHIPMENT TYPE B REPORTS</span>
    </div>
      ...
      <div class="list-inner-box">
        ...
        <div class="action-row toolbar-row">
          <div class="action-bar no-margin">
            ...
            <span class="selected-text" style="margin-left: 5px;">Selected: {{ numSelected }}</span>
          </div>
        </div>
